...
document.addEventListener("DOMContentLoaded", () => {
  const name = prompt("Selamat datang, petualang! Boleh saya tahu nama Anda?:");
  const guild = "Teyvat Guild Adventure";
  if (name) {
    document.getElementById("welcomeText").innerText = `Hi ${name}, Selamat Datang di ${guild}!`;
  }
});
